...
编程要求：
-1    1 增加：重载下标运算符[] P194，E6.3
-2    2 增加：二分法查找迭代算法。P200，E6.5(只对顺序排列的列表有效)
...
template<typename T, int size>
void seqlist<T, size>::SelectSort()
{
...
template<typename T, int size>
int seqlist<T, size>::Next(const T &x) const
{
    int i = Find(x);
...
template<typename T, int size>
int seqlist<T, size>::Prior(const T &x) const
{
    int i = Find(x);
...
{
    /////////////////////////////////////////////////////////
    seqlist<int, 100> int_obj;
    int_obj.Insert(4, int_obj.Length());
    int_obj.Insert(9, int_obj.Length());
    int_obj.Insert(9, int_obj.Length());
    int_obj.Insert(3, int_obj.Length());
    int_obj.Insert(4, int_obj.Length());
    int_obj.Insert(1, int_obj.Length());
    int_obj.Insert(0, int_obj.Length());
    int_obj.Insert(5, int_obj.Length());
    int_obj.Insert(9, int_obj.Length());
    int_obj.Insert(8, int_obj.Length());
    ...
    int_obj.Insert(8, int_obj.Length());
    int_obj.SHOW();
    int_obj.BinaryInsertSort();
    int_obj.SHOW();
    std::cout << int_obj.BinarySearch(3, 0, int_obj.Length() - 1) << std::endl;


    /////////////////////////////////////////////////////////

    seqlist<string, 100> str_obj;
    str_obj.Insert("121a", str_obj.Length());
    str_obj.Insert("cdaasa", str_obj.Length());
    str_obj.Insert("565sasa", str_obj.Length());
    str_obj.Insert("121asa", str_obj.Length());
    str_obj.Insert("vdfsasa", str_obj.Length());
    str_obj.Insert("34sasa", str_obj.Length());
    str_obj.Insert("wqssasa", str_obj.Length());
    str_obj.Insert("23s3asa", str_obj.Length());
    str_obj.Insert("sasa", str_obj.Length());
    str_obj.Insert("s2s2sasa", str_obj.Length());
    ...
    seqlist<Student, 100> stu_obj;
    stu_obj.Insert(Student(1, 100.1), stu_obj.Length());
    stu_obj.Insert(Student(6, 1212), stu_obj.Length());
    stu_obj.Insert(Student(52, 123), stu_obj.Length());
    stu_obj.Insert(Student(53, 1213), stu_obj.Length());
    stu_obj.Insert(Student(42, 112), stu_obj.Length());
    stu_obj.Insert(Student(64, 100.1), stu_obj.Length());
    stu_obj.Insert(Student(24, 100.1), stu_obj.Length());
    stu_obj.Insert(Student(3342, 100.3131), stu_obj.Length());
    stu_obj.SHOW();
    stu_obj.BubbleSort();
    stu_obj.SHOW();
